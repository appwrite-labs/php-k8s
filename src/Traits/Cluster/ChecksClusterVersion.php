...
trait ChecksClusterVersion
{
    ...
    protected function loadClusterVersion(): void
    {
        ...
        $this->kubernetesVersion = $json['gitVersion'];
    }
    ...
    public function newerThan(string $kubernetesVersion): bool
    {
        ...
        return Comparator::greaterThanOrEqualTo($this->kubernetesVersion, $kubernetesVersion);
    }
    ...
    public function olderThan(string $kubernetesVersion): bool
    {
        ...
        return Comparator::lessThan($this->kubernetesVersion, $kubernetesVersion);
    }
}
